            ...
            <div style={{ position: 'relative', padding: '56px 48px 0', maxWidth: '600px' }}>
              ...
              <div style={{ display: 'flex', gap: '12px' }}>
                <button
                  ...
                  style={{ padding: '12px 22px', backgroundColor: '#0F2E1D', color: 'white', border: 'none', borderRadius: '10px', fontSize: '14px', fontWeight: 600, cursor: 'pointer' }}
                >
                  Explore destinations
                </button>
                <button
                  onClick={scrollToDestinations}
                  style={{ padding: '12px 22px', backgroundColor: 'white', color: '#111827', border: '1px solid #e5e4e0', borderRadius: '10px', fontSize: '14px', fontWeight: 600, cursor: 'pointer' }}
                >
